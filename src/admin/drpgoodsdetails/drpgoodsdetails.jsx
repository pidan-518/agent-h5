...
export default class DrpGoodsDetails extends Component {
  constructor(props) {
    super(props);
    this.state = {
      imgUrl: require('../../static/distributionpart/goods_item.png'),  //商品图片
      name: '商品名示例',  //商品名
      introduction: '商品介绍示例商品介绍示例商品介绍示例商品介绍示例商品介绍示例商品介绍示例',  //商品介绍
      detail: {},  //商品详情
      specTagName: '',  //主规格名
  ...
  //获取商品详情
  agentGoodDetail = () => {
    const id = JSON.parse(this.$router.params.id)
    const postData = {
      id: id
    }
